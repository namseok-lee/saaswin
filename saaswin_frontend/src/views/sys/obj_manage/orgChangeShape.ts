    ...
    'Member',
    {
        ...
        attrs: {
            ...
            memberAddButton: {
                ...
                transform: 'translate(calc(w- 5), calc(h - 55))',
                z: 10,
                'data-tooltip': '하위조직 추가',
                'data-tooltip-position': 'top',
                ':hover': {
                    fill: 'var(--primary)',
                    stroke: 'var(--primary)',
            ...
            memberAddButtonIcon: {
                d: 'M3.56251 4.93749H0.208348V4.06251H3.56251V0.708347H4.43749V4.06251H7.79165V4.93749H4.43749V8.29165H3.56251V4.93749Z',
                stroke: '#666666',
                ':hover': {
                    fill: '#FFFFFF',
                    stroke: '#FFFFFF',
            ...
            toggleButton: {
                ...
                transform: 'translate(calc(w- 40), calc(h - 55))',
                z: 10,
                'data-tooltip': '접기/펼치기',
