...
import HrInfoProfile from './HrInfoProfile';
...
export default function XOA001({ tpcdParam }: { tpcdParam: string }) {
    ...
    const getTpcdByCardKey = (key: string): string => {
        const cardMapping: Record<string, string> = {
            cardSlot1: 'RE001T01', // 근로자정보
            cardSlot2: 'RE001T02', // 주소/연락처
            cardSlot3: 'RE001T03', // 발령
            cardSlot4: 'RE001T04', // 학력
            cardSlot5: 'RE001T05', // 경력
            cardSlot6: 'RE001T06', // 자격
            cardSlot7: 'RE001T07', // 어학
            cardSlot8: 'RE001T08', // 직무이력
            cardSlot9: 'RE001T09', // 교육
            cardSlot10: 'RE001T10', // 상벌
            cardSlot11: 'RE001T11', // 병역
            cardSlot12: 'RE001T12', // 가족
            cardSlot13: 'RE001T13', // 장애
            cardSlot14: 'RE001T14', // 보훈
            cardSlot15: 'RE001T15', // 자료함
        };

        return cardMapping[key] || 'RE001T01';
    };
                ...
                {dragEnabled ? (
                    <h3 className={styles.title}>
                        ...
                        <div className={styles.guideText}>
                            <IcoExclamation fill='var(--primary)' /> 드래그로 카드 순서를 변경하세요
                        </div>
                        <div className={styles.options}>
                            <Button type='default' size='sm' onClick={toggleDrag}>
                                닫기
                            </Button>
                            <Button
                                type='default'
                            ...
                            <Button type='primary' size='sm' onClick={handleSaveOrder}>
                                저장
                            </Button>
                        </div>
                    </h3>
                    ...
                    <h3 className={styles.title}>
                        <div></div>
                        <Button type='default' size='sm' onClick={handleBackToList}>
                            목록으로 돌아가기
                        </Button>
                    </h3>
                ) : (
                    <h3 className={styles.title}>
                        {userData?.bsc_info?.korn_flnm} 님의 인사 정보 요약
                        <Button type='default' size='sm' className={styles.btnShowSummary}>
                            인사기록 카드 보기
                        </Button>
                    </h3>
                )}
